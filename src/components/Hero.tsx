const HERO_IMAGE = 'https://pixabay.com/get/gdf150c72a69067c51ffb749df0a77f237a27bc7a1fe2093ceccb44994ac43e3d0abe40a0c8e78185e9a277bb1554870f68328b08e71b4e80c5199034eedd6398_1280.jpg';
...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-20 left-10 w-80 h-80 bg-brand-900/15 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }} />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-16">
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center gap-2 bg-carbon-800/60 backdrop-blur-sm border border-brand-700/30 rounded-full px-4 py-2 mb-8">
            ...
            <span className="text-silver-300 text-sm font-mono tracking-wider">Premier Engineering Solutions · Sri Lanka</span>
          </div>
          ...
          <p className="text-silver-400 text-lg sm:text-xl lg:text-2xl leading-relaxed mb-10 max-w-3xl">
            Expert 3D Modeling, Precision Engineering, and Advanced Prototyping Solutions — 
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
            {STATS.map((stat, i) => (
              ...
              >
                <div className="text-3xl font-bold text-brand-400 stat-number mb-1">{stat.value}</div>
                <div className="text-silver-500 text-sm font-medium">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center gap-2 animate-bounce">
        <span className="text-silver-600 text-xs font-mono tracking-widest uppercase">Scroll</span>
