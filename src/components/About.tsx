...
export default function About() {
  return (
    <section id="about" className="py-24 bg-carbon-900 relative overflow-hidden">
      {/* Background accent */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-brand-400 font-mono text-sm tracking-widest uppercase">About MechaCAD</span>
            </div>
            ...
            <p className="text-silver-400 text-lg leading-relaxed mb-6">
              MechaCAD Solutions is Sri Lanka's premier engineering and digital manufacturing firm, 
              specializing in bridging the gap between complex digital designs and high-quality 
              physical products. We serve both <span className="text-silver-200 font-medium">engineering industries</span> and <span className="text-silver-200 font-medium">non-engineering applications</span> with equal precision.
            </p>
            
            <p className="text-silver-500 leading-relaxed mb-10">
              Whether you're an engineer needing precise CAD models, a business requiring branded 
              signage, or a creator with a cultural vision — our team delivers with <em className="text-brand-400 not-italic font-medium">perfect finish</em> every time. 
              From concept sketches to functional prototypes, we are your complete manufacturing partner.
            </p>

            {/* Highlight badges */}
            <div className="flex flex-wrap gap-3">
              {['Functional Engineering', 'Perfect Finish', 'Concept to Reality', 'Fast Turnaround'].map((tag) => (
                <span
                  key={tag}
