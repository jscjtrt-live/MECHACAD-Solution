...
export default function Contact() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.open(`https://wa.me/94${WHATSAPP_NUM.replace(/\D/g, '').slice(1)}?text=${msg}`, '_blank');
    setSubmitted(true);
  };

  return (
    <section id="contact" className="py-24 bg-carbon-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-brand-400 font-mono text-sm tracking-widest uppercase">Get In Touch</span>
            <div className="h-px w-10 bg-brand-500" />
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-carbon-800 border border-green-700/40 rounded-xl p-6">
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  <div className="text-white font-bold text-xl">{PHONE_NUM}</div>
                  <div className="text-green-400 text-sm">WhatsApp & Phone Available</div>
                </div>
              </div>
              <a
            ...
            <div className="bg-carbon-800 border border-carbon-700 rounded-xl p-6 space-y-5">
              ...
              {[
                { icon: 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z', label: 'Phone / WhatsApp', value: PHONE_NUM },
                { icon: 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', label: 'Email', value: 'info@mechacad.lk' },
                { icon: 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z', label: 'Location', value: 'Sri Lanka' },
                ...
                <div key={item.label} className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="text-silver-500 text-xs mb-0.5">{item.label}</div>
            ...
            <div className="bg-carbon-800/60 border border-carbon-700/40 rounded-xl p-6">
              ...
              <div className="space-y-4">
                {[
                  { step: '01', title: 'Share Your Concept', desc: 'Send us your idea, sketch, or requirement' },
                  { step: '02', title: 'Free Consultation', desc: 'We discuss feasibility and provide a quote' },
                  { step: '03', title: 'Design & Manufacture', desc: 'We create your project with precision' },
                  { step: '04', title: 'Perfect Delivery', desc: 'Receive your finished product, ready to use' },
                ].map((item) => (
          ...
          <div>
            {submitted ? (
              <div className="bg-carbon-800 border border-green-600/40 rounded-xl p-10 text-center h-full flex flex-col items-center justify-center">
                ...
                <p className="text-silver-400 mb-6">We've opened WhatsApp for you. We'll respond within 24 hours.</p>
                <button
              ...
              <form onSubmit={handleSubmit} className="bg-carbon-800 border border-carbon-700 rounded-xl p-8 space-y-5">
                <h3 className="text-white font-bold text-xl mb-2">Tell Us About Your Project</h3>
                <p className="text-silver-500 text-sm mb-6">Fill in the details and we'll send it straight to WhatsApp.</p>

                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-silver-400 text-sm font-medium mb-2">Full Name *</label>
                  ...
                  <div>
                    <label className="block text-silver-400 text-sm font-medium mb-2">Phone / WhatsApp *</label>
                ...
                <div>
                  <label className="block text-silver-400 text-sm font-medium mb-2">Email Address</label>
                ...
                <div>
                  <label className="block text-silver-400 text-sm font-medium mb-2">Service Required *</label>
                  <select name="service" required value={form.service} onChange={handleChange}
                    ...
                    <option value="" className="bg-carbon-900 text-silver-500">Select a service...</option>
                    {SERVICES_LIST.map(s => <option key={s} value={s} className="bg-carbon-900">{s}</option>)}
                  </select>
                </div>

                <div>
                  <label className="block text-silver-400 text-sm font-medium mb-2">Estimated Budget (LKR)</label>
                  <select name="budget" value={form.budget} onChange={handleChange}
                    className="w-full bg-carbon-900 border border-carbon-600 focus:border-brand-500 rounded-lg px-4 py-3 text-white text-sm transition-colors duration-200">
                    <option value="" className="bg-carbon-900">Not sure yet</option>
                    <option value="Under 5,000" className="bg-carbon-900">Under LKR 5,000</option>
                    <option value="5,000 - 20,000" className="bg-carbon-900">LKR 5,000 - 20,000</option>
                    <option value="20,000 - 50,000" className="bg-carbon-900">LKR 20,000 - 50,000</option>
                    <option value="50,000 - 100,000" className="bg-carbon-900">LKR 50,000 - 100,000</option>
                    <option value="Above 100,000" className="bg-carbon-900">Above LKR 100,000</option>
                  </select>
                </div>

                <div>
                  <label className="block text-silver-400 text-sm font-medium mb-2">Project Details *</label>
                ...
                <p className="text-silver-600 text-xs text-center">
                  By submitting, you'll be redirected to WhatsApp. We respond within 24 hours.
                </p>
              </form>
            )}
          </div>
